...
abbr gl 'git pull'
abbr ggl 'git pull origin (__git.current_branch)'
...
abbr ggp 'git push origin (__git.current_branch)'
abbr ggp! 'git push origin (__git.current_branch) --force-with-lease'
abbr gpu 'git push origin (__git.current_branch) --set-upstream'
abbr gpoat 'git push origin --all; and git push origin --tags'
abbr ggpnp 'git pull origin (__git.current_branch); and git push origin (__git.current_branch)'
...
abbr grbom 'git fetch origin (__git.default_branch); and git rebase FETCH_HEAD'
abbr grbomi 'git fetch origin (__git.default_branch); and git rebase FETCH_HEAD --interactive'
abbr grbomia 'git fetch origin (__git.default_branch); and git rebase FETCH_HEAD --interactive --autosquash'
...
abbr ggu 'git pull --rebase origin (__git.current_branch)'
...
abbr gmr 'git push origin (__git.current_branch) --set-upstream -o merge_request.create'
abbr gmwps 'git push origin (__git.current_branch) --set-upstream -o merge_request.create -o merge_request.merge_when_pipeline_succeeds'
abbr psh powershell.exe
abbr fnet 'cd $HOME/onedrive/VPN && powershell.exe -File setup-vpn.ps1'
abbr lg lazygit
abbr lzd lazydocker
abbr vim nvim
abbr vi vim
...
abbr cgn 'cargo new'
abbr cgs 'cargo search'
abbr cgt 'cargo test'
abbr cgu 'cargo uninstall'
abbr cgug 'cargo upgrade'
abbr h history
