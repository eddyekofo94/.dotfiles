...
record result "$(jq -cn '{status:"PASS",version:"herdr 0.7.4",session:"wn",model:"workspaces-within-session",production_configuration_modified:false,migration_authorized:false}')"
